...
# OPERASI STRING 13 #
'''Operasi yang bekerja pada string'''
print('# OPERASI STRING 13 # ')
print('\n')

print('Menyambung String')
Nama_Pertama = 'John'
Nama_Tengah = 'F'
Nama_Belakang = 'Kennedy'

Nama_Lengkap = Nama_Pertama + ' ' + Nama_Tengah + "'" + Nama_Belakang
print(Nama_Lengkap)
print('\n')

print('Menghitung panjang dari string')
Panjang_Nama_Lengkap= len(Nama_Lengkap)
print('Panjang Nama Lengkap adalah ' + str(Panjang_Nama_Lengkap))
print('\n')

print('Mengecek apakah suatu string ada dalam suatu string lain')
John = 'John' in Nama_Lengkap
john = 'john' in Nama_Lengkap
print('Apakah John ada di ' + Nama_Lengkap + ' ' + str(John))
print('Apakah john ada di ' + Nama_Lengkap + ' ' + str(john))
print('\n')

# Indexing
print('# Indexing')
'''Memanggil karakter string berdasarkan range tertentu. Dimulai dari 0 hingga urutan terakhir
dari suatru string'''
print('\n')

print('indexing satu character string')
print('Index ke 10 dari ' + Nama_Lengkap + ' adalah ' + Nama_Lengkap[10])
print('Index ke 5 dari ' + Nama_Lengkap + ' adalah ' + Nama_Lengkap[5])
print('Index ke -9 dari ' + Nama_Lengkap + ' adalah ' + Nama_Lengkap[-9]) # Untuk index mines akan dimulai dari index ke terakhir lalu ke depan
print('\n')

print('indexing string dari range tertentu')
'''Saat indexing pada range atau jarak tertentu, index terakhir akan memanggil satu karakter
ke depan. Sehingga perlu memanggil dari satu index berikutnya seperti contoh dibawah'''
print('Index ke 1 sampai 5 dari ' + Nama_Lengkap + ' adalah ' + (Nama_Lengkap[1:6]))
print('Index ke 1 sampai 8 dari ' + Nama_Lengkap + ' adalah ' + (Nama_Lengkap[1:9]))
print('\n')

print('indexing string dengan melompati setiap periode tertentu')
print('Index ke 1 sampai 14 dari ' + Nama_Lengkap + ' adalah ' + (Nama_Lengkap[1:14:3]))
print('Index ke 1 sampai 14 dari ' + Nama_Lengkap + ' adalah ' + (Nama_Lengkap[1:14:2]))
print('\n')

# Ascicode
'''Ascicode adalah id yang telah ditetapkan oleh bahasa python untuk masing masing 
SATU string'''
print('# Ascicode')
Ascicode_L = ord('L')
Ascicode_123 = chr(123)
print('Ascicode untuk huruf L adalah ' + str(Ascicode_L))
print('123 adalah ascicode untuk ' + str(chr(123)))
print('\n')

#Min & Max
print('Mencari Ascicode terkeceil (MIN) dan Terbesar (MAX)')
print('Ascicode terkecil dari ' + Nama_Lengkap + ' adalah' + ' ' + str(min(Nama_Lengkap)) + '(SPASI)')
print('Ascicode terbesar dari ' + Nama_Lengkap + ' adalah' + ' ' + str(max(Nama_Lengkap)))
print('\n')

# Operasi string dalam bentuk method
print('# Operasi string dalam bentuk method')
'''Method adalah bentuk operasi yang bekerja langsung atau menempel pada sebuah object'''
print('\n')

print('Menghitung jumlah suatu string pada string tertentu')
Jumlah_o = Nama_Belakang.count('o')
print('Jumlah o pada ' + Nama_Lengkap + ' adalah ' + str(Jumlah_o))
Jumlah_e = Nama_Belakang.count('e')
print('Jumlah e pada ' + Nama_Lengkap + ' adalah ' + str(Jumlah_e))